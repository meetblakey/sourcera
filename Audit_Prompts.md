...
2. Why Managed Agents not Agent SDK (§22.2.2) retains required historical baseline coverage from retired KB Spec §2.3.
3. Beta header & version pinning (§22.2.3) retains required historical baseline coverage from retired KB Spec §2.4 —
   confirm `managed-agents-2026-04-01` pin and the upgrade
   playbook.
4. Ingestion channels (§22.3) include Firecrawl, document upload,
   manual entry, and any others represented in the historical baseline.
...
### Prompt 14.3 — Master Spec ↔ Retired KB Engineering Spec Snapshot
...
OUTPUT
- CONSISTENCY_DELTA.md updated under "Retired KB Engineering Spec Snapshot".
- Defect ledger entries.
```
