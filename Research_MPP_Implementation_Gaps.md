...
**v1 → v2 delta:** v1 named §7.2 / §22.16 / §27.6 / §27.10 incorrectly throughout, framed Decision Layer as a "third console," and required a substantial volume of new authoring that v2's reuse-of-primitives reframing eliminates. v2 corrects citations, reframes scope to "extend existing primitives, don't parallel them," and shrinks the engineering FTE-month estimate from 10–14 to 8–11. Total Spec authoring + ops + UX + GTM + security + QA work shrinks from ~21–25 FTE-months to ~14–18 FTE-months. Pre-rewrite snapshot at `legacy-import:_versions/Research_MPP_Implementation_Gaps.v1-pre-comprehensive-rewrite-2026-04-29.md`.
