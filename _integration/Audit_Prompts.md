...
- §4.4.21 VerificationReviewRecord and §27.11.3 Verification Tiers; §34.1.2 owns Seller Solo eligibility. §27.10 is Vendor Opt-Out and MUST NOT be used as the Verification anchor.

### Audit checklist
1. Convention Checklist §0.6.
2. Marketplace-domain isolation enforced — no cross-domain leakage.
3. Verification tier ladder explicit, with Seller Solo eligibility resolved through §4.4.21 AC #1 and §34.1.2.
...
>
> Read §27 in full. Read Seller Pricing §Marketplace Discovery Pricing. Run Convention Checklist §0.6 and Edge-Case Discipline §0.7. Verify domain isolation, the §4.4.21 / §27.11.3 verification ladder with §34.1.2 Seller Solo eligibility, seller-signal computation, ranking determinism, and marketplace-visitor UX. Log defects. Resolve P0 in-place. Produce verify log + RECONCILIATION entry.
