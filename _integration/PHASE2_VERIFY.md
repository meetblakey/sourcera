...
3. `Sourcera_Master_Summary.md` — historical input for concepts not yet integrated at this pass; superseded by the Master Spec after v7.0.0 integration and never current authority.

**Verification date.** 2026-04-18.

**Current-authority supersession (2026-07-11).** The list above records the April 2026 verification context. For all current pricing and billing work, the Master Spec is canonical; the Buyer and Seller Pricing Strategies are companions, and the retired Master Summary is historical provenance only. This note governs future use of this log without changing its dated findings.
