...
- **Status:** One of `pending`, `partially_closed`, `closed`, or `superseded`; include date and closure source when known.
- **Defect Link:** Required only when status is `pending` or `partially_closed`; cites the active `D-DEC-*` or successor row.
...
**Status:** closed 2026-06-23 — remediated by D-DEC-001; Phase 1 billing-pipeline monetary fields now use integer cents.
...
**Status:** closed 2026-05-12 — verified implemented in Master Spec §4.2.1 by `_audit/DECISIONS_STATUS_REPORT.md`.
...
**Status:** closed 2026-05-12 — verified implemented in Master Spec §4.3.20, §4.3.21, §4.3.22, and §4.6 by `_audit/DECISIONS_STATUS_REPORT.md`.
...
**Status:** closed 2026-05-12 — verified implemented by Appendix C / Appendix G event registrations in `_audit/DECISIONS_STATUS_REPORT.md`.
...
**Status:** closed 2026-06-23 — remediated by D-DEC-002; required Phase 1 indexes and `UsageEventDailyAggregate` landed.
...
**Status:** closed 2026-06-21 — remediated by D-DEC-003 in the Phase 5.3 KB data-model pass.
...
**RECONCILIATION.md ref:** Phase 22-Rewrite Continuation Known Gaps
**Status:** closed 2026-06-23 — remediated by D-DEC-004; seller-side routing now uses coarsened `bid_workspace_deal_size_band`.
...
**Owner:** Engineering
**RECONCILIATION.md ref:** Phase 22-Rewrite Continuation Known Gaps
**Status:** closed 2026-07-09 — adopted in Master Spec §22.13.1, §22.16.4, §42.2.3, §42.5.1, §50.15.4, §50.15.5, Appendix J, and §M.5.71 by D-DEC-009 closure.
...
**RECONCILIATION.md ref:** Phase 22-Rewrite Continuation Known Gaps
**Status:** closed 2026-05-12 — verified aligned with the engineering-internal recommendation by `_audit/DECISIONS_STATUS_REPORT.md`.
...
**Status:** closed 2026-05-12 — Phase 1.5 executed; residuals were carried into the D-DEC cluster and later closed by row status.
...
**Status:** closed 2026-06-24 — adopted in Master Spec §34.10.3 by D-DEC-005 wallet-pool additive decision closure.
...
**Closure (2026-06-24).** Adopted. Master Spec §34.10.3 now renders Buyer Free + Seller Free as one $10 Org-scoped AIWallet pool, with no per-console wallet partition. D-DEC-005 is remediated by selecting this additive-pool recommendation and superseding the prior $5 collapse Authored Extension.
...
**Closure (2026-06-24).** Adopted. Master Spec §34.10.3 now adds the Free side's $5 contribution to any customer-visible paid AIWallet pool, with Solo preserved as the explicit engine-side / hidden-envelope exception. Example: Buyer Growth + Seller Free renders one $305 pool; paid+Free downgrade to Free+Free recalculates to $10 at billing rollover.
...
**Status:** closed 2026-06-23 — remediated by D-DEC-007; no-refund-after-vendor-notification semantics landed.
...
**Status:** closed 2026-07-09 — adopted in Master Spec §34.13.2.A and §48.7.4 by D-DEC-006 closure.
...
**Closure.** The Master Spec now enforces the `ops_pricing_admin` role gate, 90-day maximum window, 3x plan-default cap, paired override audit trail, and daily auto-revert job.
...
**Status:** closed 2026-05-12 — verified aligned with the ship-without-toggle recommendation by `_audit/DECISIONS_STATUS_REPORT.md`.
...
**Status:** closed 2026-07-09 — adopted in Master Spec §4.8.6, §34.3.3, §34.11.3, Appendix J, Appendix K, and §M.5.70 by D-DEC-010 closure.
...
**Closure (2026-07-09).** Adopted. Master Spec §4.8.6, §34.3.3, §34.11.3, Appendix J, Appendix K, and §M.5.70 now use the 7/10/25 bands. `warning_5_10` is retired as a legacy migration alias and new writes use `warning_7_10`. Runtime-active CI gate `cost_base_drift_threshold_canonicality` prevents the 5% floor from returning.

**Original defer posture.** The system would have shipped with 5/10/25 defaults. Finance would get noisy alerts for the first month, someone would raise a ticket, and the threshold would get adjusted to 7%. Total cost: one sprint of alert fatigue. Not catastrophic.
...
**Status:** closed 2026-06-23 — remediated by D-DEC-008; Enterprise Ops Finance auto-topup override path landed.
...
**Blocker Level:** NON-BLOCKING
**Owner:** Trust & Safety
**Status:** closed 2026-07-09 — adopted in Master Spec §22.16.7, §22.17 AC #46, §42.2.3, §42.5.1, §50.14.6, Appendix G, Appendix J, and §M.5.72 by D-DEC-011 closure.
...
Status fields above are canonical. The table below preserves the original advisory ordering and is not a current open-work list.
...
| C-1 | Free+Free pool collapse | HARD | Collapse to single $10 pool | Sales-Ops + Founder | Closed 2026-06-24 — adopted in §34.10.3 / D-DEC-005 |
| C-2 | Free+Paid pool collapse | HARD | Collapse to single combined pool | Sales-Ops + Founder | Closed 2026-06-24 — adopted in §34.10.3 / D-DEC-005 |
...
**Status:** closed 2026-05-12 — verified implemented in Master Spec §34.14.1 / §34.14.1.b, §34.15.1 / §34.15.1.b, and §34.17.1 / §34.17.1.b by `_audit/DECISIONS_STATUS_REPORT.md`.
...
**Status:** closed 2026-05-12 — verified implemented in Master Spec §34.15.1 and §34.15.1.b by `_audit/DECISIONS_STATUS_REPORT.md`.
...
**Status:** closed 2026-05-12 — verified implemented in Master Spec §34.17.1 and §34.17.1.b by `_audit/DECISIONS_STATUS_REPORT.md`.
...
**Status:** closed 2026-05-12 — verified implemented by `AuthoredExtensionSignoff`, `rate_card_ae_signoff_gate`, and `capability_not_signed_off` contracts in `_audit/DECISIONS_STATUS_REPORT.md`.
...
**Status:** closed 2026-04-26 — closure recorded below and verified by `_audit/DECISIONS_STATUS_REPORT.md`.
...
**Decision.** **SEP retained as the headline category framing**; "Programmatic RFP Exchange" is a **marquee positioning of the Marketplace surface**, not a category rename. Sourcera remains "the Software Evaluation Platform" (or "SEP") in headline positioning copy across `GTM/GTM_POSITIONING.md`, `GTM/GTM_SALES_PLAYBOOK.md`, and the Master Spec §1 Architecture preamble. The Marketplace surface (§27, §4.5) is the canonical home for the "Programmatic RFP Exchange" marquee.
