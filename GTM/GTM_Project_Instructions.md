...
1. **Sourcera_Master_Spec.md** — Canonical product, pricing, PLG, Marketplace, Seller KB, and commercial-wedge authority. Minimum GTM read: §1, §2, §22, §27, §34, §48, §49.
2. **Sourcera_Buyer_Pricing_Strategy.md** — Buyer pricing companion. Use for narrative and packaging explanation; cite Master Spec §34 for numerical authority.
3. **Sourcera_Seller_Pricing_Strategy.md** — Seller pricing companion. Use for forced-signup, Hero Moment, KB value capture, and seller network-effect narrative; cite Master Spec §34 / §48 for authority.
4. **Relevant GTM deliverable** — Read the current GTM artifact before extending or rewriting it.
...
- All product claims must be traceable to `Sourcera_Master_Spec.md`.
- All pricing numbers must cite Master Spec §34. Buyer and Seller Pricing Strategy files are companion narrative only.
- Commercial-wedge claims must cite Master Spec §48.0.1 / §48.
...
1. Re-read Sourcera_Master_Spec.md (§1, §2, §22, §27, §34, §48 minimum)
