...
- `Sourcera_Master_Spec.md` — canonical product, pricing, Marketplace, Seller KB, PLG, network-effect, and commercial-wedge authority
...
1. Sourcera_Master_Spec.md — Read §1, §2, §22, §27, §34, §48, and §49. Use §34 for pricing numbers and §48.0.1 / §48 for the commercial wedge, PLG motion, growth loops, network effects, Hero Moment, conversion moments, and seller activation.
2. Sourcera_Buyer_Pricing_Strategy.md — Read for buyer pricing narrative, conversion triggers, competitive anchors, financial scenarios, and pricing philosophy. Master Spec §34 remains numerical authority.
3. Sourcera_Seller_Pricing_Strategy.md — Read for seller pricing narrative, forced-signup mechanics, Hero Moment details, conversion moments, KB value capture, seller competitive anchors, and seller financial scenarios. Master Spec §34 / §48 remain authority.
</context_loading>

<deliverable>
Produce a single comprehensive document saved to GTM_POSITIONING.md with the following sections. Every element must be derived from what Sourcera actually does as specified in the source docs. Do NOT use generic B2B frameworks.

SECTION 1: IDEAL CUSTOMER PROFILE (ICP)
The Master Spec §1 already defines Primary ICP (buyers), Secondary ICP (sellers), and Wedge ICP. Your job is to go DEEPER on each:
...
- Category name: "Software Evaluation Platform" (per Master Spec §1)
...
- If compacted: re-read Sourcera_Master_Spec.md §1, §2, §22, §27, §34, §48 and resume from the next incomplete section.
</anti_drift>
```
...
1. Sourcera_Master_Spec.md — Focus on: §34 (pricing), §48.0.1 / §48 (commercial wedge, PLG motion, 10 growth loops, M1-M17, Hero Moment, conversion moments, seller activation metric, leading indicators, anti-spam controls), §22.18 (KB Value Capture), and §27 (Marketplace).
2. Sourcera_Seller_Pricing_Strategy.md — Focus on: forced-signup mechanics, hero moment, three conversion moments, win/loss debrief, activation metric, leading indicators, financial scenarios
3. Sourcera_Buyer_Pricing_Strategy.md — Focus on: buyer PLG flow, aha moment, ceiling hits, PQL signals, financial scenarios
4. GTM_POSITIONING.md — ICP and personas from Prompt 1
</context_loading>

<deliverable>
Produce GTM_PLG_ARCHITECTURE.md covering:
...
- How Template Library and Template Discovery (Master Spec §19 / §19.4 / §19.5) accelerate setup

SECTION 3: SELLER-SIDE ACTIVATION ARCHITECTURE — THE HERO MOMENT
The Master Spec §48.0.1 / §48.8 specifies the Hero Moment in detail. Your job is to design the OPERATIONAL execution:
...
- The onboarding anti-patterns (§48.8.7 bans: no credit card ask, no company form, no "try Pro free" modal, no pricing page before first bid)
...
For each of M1-M17 (listed in Master Spec §48), produce:
...
For each of the 10 loops in Master Spec §48, define:
...
- If compacted: re-read Sourcera_Master_Spec.md §34 / §48 and resume.
</anti_drift>
```
...
<context_loading>
Read these files completely:
1. Sourcera_Master_Spec.md — Focus on §1 / §2 (product framing), §34 (pricing), §48.0.1 / §48 (PLG and wedge), §22 (Seller KB), and §27 (Marketplace).
2. Sourcera_Buyer_Pricing_Strategy.md — Buyer pricing, financial scenarios
3. Sourcera_Seller_Pricing_Strategy.md — Seller pricing, competitive anchors
4. GTM_POSITIONING.md — ICP, personas, messaging
5. GTM_PLG_ARCHITECTURE.md — PLG mechanics, PQL scoring
</context_loading>

<deliverable>
Produce GTM_SALES_PLAYBOOK.md covering:
...
- If compacted: re-read Sourcera_Master_Spec.md, GTM_POSITIONING.md, GTM_PLG_ARCHITECTURE.md, then resume.
</anti_drift>
```
...
<context_loading>
Read completely:
1. Sourcera_Master_Spec.md — Focus on §1 (category, positioning), §27 (Marketplace), and §48 (M9-M13 content mechanics, SEO loops, growth mechanics).
2. GTM_POSITIONING.md — ICP, personas, messaging, category definition
3. If available: GTM_SALES_PLAYBOOK.md — objections and pain points
</context_loading>

<deliverable>
Produce GTM_CONTENT_ENGINE.md covering:
...
- How Seller Org Pages and Software Pages (Master Spec §26.7 / §26.8.5) compound SEO via Schema.org structured data
...
- If compacted: re-read Sourcera_Master_Spec.md §3 and GTM_POSITIONING.md, then resume.
</anti_drift>
```
...
<context_loading>
Read completely:
1. Sourcera_Master_Spec.md — Focus on §48.0.1 / §48 (10 growth loops, M1-M17, seller-side network effects, anti-spam controls, Hero Moment), §27 (Marketplace), §22 / §22.18 (Seller KB and KB Value Capture), and §34 (invited participation, Marketplace Discovery pricing, plan behavior).
2. Sourcera_Seller_Pricing_Strategy.md — Focus on: seller network effects, forced-signup mechanics, competitive positioning, revenue projections
3. GTM_POSITIONING.md — ICP and competitive positioning
</context_loading>

<deliverable>
Produce GTM_NETWORK_EFFECTS.md covering:

SECTION 1: NETWORK EFFECTS INVENTORY — OPERATIONAL STATUS
For each of the 10 growth loops and 7 seller-side network effects in Master Spec §48:
...
- The "your profile is already live" pitch (published from day one per Master Spec §26.1 / §26.7.3)
...
- If compacted: re-read Sourcera_Master_Spec.md §48 and resume.
</anti_drift>
```
...
<context_loading>
Read:
1. Sourcera_Master_Spec.md — §48 (all growth loops and mechanics)
2. GTM_POSITIONING.md
3. GTM_PLG_ARCHITECTURE.md
</context_loading>

<deliverable>
Produce GTM_GROWTH_TACTICS.md
...
<context_loading>
Read completely:
1. Sourcera_Master_Spec.md — Focus on §1 / §2 (product framing), §27 (Marketplace), §34 (pricing), §48.0.1 / §48 (growth and commercial wedge), and §49.
2. GTM_POSITIONING.md — ICP, personas, competitive positioning, value props
3. GTM_SALES_PLAYBOOK.md — Pricing narrative, objection handling
</context_loading>
...
<anti_drift>
- All product claims from Sourcera_Master_Spec.md.
...
- If compacted: re-read Sourcera_Master_Spec.md and GTM_POSITIONING.md, then resume.
</anti_drift>
```
...
<context_loading>
Read ALL:
1. Sourcera_Master_Spec.md — §1, §2, §22, §27, §34, §48, §49
2. GTM_POSITIONING.md
3. GTM_PLG_ARCHITECTURE.md
4. GTM_SALES_PLAYBOOK.md
5. GTM_CONTENT_ENGINE.md
6. GTM_NETWORK_EFFECTS.md
7. GTM_GROWTH_TACTICS.md
</context_loading>

<deliverable>
Produce GTM_90DAY_SPRINT.md covering:
