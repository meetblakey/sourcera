...
**Source authority:** `Sourcera_Master_Spec.md` §4.3.16, §4.4.16, §4.4.28, §5, §10.12, §19, §20, §27, §34, §41, §48, §49, §51.6 · `GTM_POSITIONING.md` v1.0 §1 (ICP), §2-§3 (Personas), §6 (Category) · `GTM_PLG_ARCHITECTURE.md` v1.0 §1-§3 (Entry paths, activation), §5 (Mechanic execution plan).
