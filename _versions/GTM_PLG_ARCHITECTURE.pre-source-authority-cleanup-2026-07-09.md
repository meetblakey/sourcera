...
**Date:** 2026-04-20
**Source-of-Truth:** `Sourcera_Master_Spec.md` §22, §27, §34, §48, §49 · `Sourcera_Seller_Pricing_Strategy.md` v3 · `Sourcera_Buyer_Pricing_Strategy.md` v3 · `GTM_POSITIONING.md` §1–§3
...
The seller onboarding surface **must not** do any of the following — any deviation requires formal product review (mirrors `Master Spec §48` and `§6.28.2`):
...
Enterprise is gated (Master Spec §34, §6 Buyer Pricing). The trigger is **not** size — it is any one of {SSO required, DPA required, ≥$12K/yr AI commit, custom integration}. The operational challenge is identifying these triggers before the user churns from Scale.
