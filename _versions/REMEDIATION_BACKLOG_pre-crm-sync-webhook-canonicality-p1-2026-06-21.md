...
| 4 | BL-P1-PH31-RBAC | Phase 3.1 | rbac / consistency_drift | 5 | D-3.1-003, D-3.1-004, D-3.1-005, D-3.1-007, D-3.1-014 | §5 + §50.3 | Residual true §5 body/config conflicts after the 2026-06-21 stale-sync pass: Member operation-level permissions, Org Owner/Admin console-firewall carveout, Org Admin billing-read consistency, Buyer Console per-role permission lists, and Seller Console operation-level permission lists. | Author the missing §5 operation-level permission lists and firewall carveouts, then resolve the Org Admin billing-read conflict across §5.2 / §4.8 / §5.11. Keep D-3.1-008 / D-3.1-016 / D-3.1-020 in the Appendix K glossary backlog, not this RBAC body cluster. | Engineering | M11.3 | L | PROD-027 | AE row for Feature Access Matrix completeness |
...
| 6 | BL-P1-PH8-WH | Phase 8 | webhook | 9 | D-V8.1-021, D-8.2-010, D-8.2-012, D-8.2-013, D-8.2-014 (+4 more) | §31 + Appendix C + Appendix G + Appendix F | Residual webhook event-catalog coverage after the Webhook Foundation, Delivery Attempt, Event ID Format, and Retry Singleton passes: billing-domain §32.8 emissions, CRM event-name drift, referral / trial / KB / wallet / committed-spend / contest lifecycle webhooks, and subscription-registration guard. | Author per-event §31 payloads + Appendix C/G/F rows; root envelope/version/class/attempt/id-format, rotation, 4xx retry semantics, canonical retry curves, and retired retry-class cleanup are closed by AE-V72REM-WEBHOOK-FOUNDATION-01, AE-V72REM-WEBHOOK-DELIVERY-ATTEMPT-01, AE-V72REM-WEBHOOK-EVENT-ID-FORMAT-01, and AE-V72REM-WEBHOOK-RETRY-SINGLETON-01. | Engineering | M02.3 | L | PROD-267 | AE-V72REM-WEBHOOK-FOUNDATION-01 + AE-V72REM-WEBHOOK-DELIVERY-ATTEMPT-01 + AE-V72REM-WEBHOOK-EVENT-ID-FORMAT-01 + AE-V72REM-WEBHOOK-RETRY-SINGLETON-01 plus future per-event catalog AE rows |
