...
**Observed:** live gate PASS; positive fixture PASS; negative fixture FAIL with four expected findings; typecheck PASS; full spec-lint PASS; exact-status scan 0 / 0 / 509 / 173; stamp gate FAIL only on the unchanged 144 runtime-evidence blockers.
