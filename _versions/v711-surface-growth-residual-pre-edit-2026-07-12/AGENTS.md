...
**Current release correction (2026-07-12, billing settlement resilience P2 closure).** The preceding correction is a pass boundary. D-CONS-015, D-CONS-016, D-CONS-018, and D-CONS-019 are remediated. §4.8.3 / §32.8.4 bound daily automatic-charge frequency; free-allowance settlement has no Stripe meter and restores exactly one unit only on approved reversal; Solo BillingEvent refunds are separated from zero-charge AIOperation corrections; and §44.1 / §34.11.5 own Outcome Resolver deadline/backlog recovery. Live status is **0 open P0, 0 open P1, 0 blocked P1, 25 open P2, and 0 open P3**. The stamp gate parses **539** runtime rows, **333** `runtime_active`, and **204** product/runtime blockers: **136 M11.3, 39 M21.3, 17 M02.3, and 12 M24.3**. Four product-evidence rows remain pending; no runtime row is promoted.

**Current release correction (2026-07-12, privacy and residency residual P2 closure).** The preceding correction is a pass boundary. D-9.1R-023, D-9.2-004, D-9.2-012, D-12V-007, D-12V-009, and D-12V-010 are remediated. §40.2 now resolves residency for every retention row; §6.8.5.1 separates rotating identity epochs from fixed destroyed-source scrub proofs; §4.6.5 / §6.8.6.2.1 define the manifestly-unfounded appeal lifecycle; and three V12 rows are synchronized to current §42 / §46 / §50 source. Live status is **0 open P0, 0 open P1, 0 blocked P1, 19 open P2, and 0 open P3**. The stamp gate parses **542** runtime rows, **333** `runtime_active`, and **207** product/runtime blockers: **139 M11.3, 39 M21.3, 17 M02.3, and 12 M24.3**. No runtime row is promoted.
