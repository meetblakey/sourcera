...
- **Mechanic:** Command Palette (§30 / §3.2) surfaces relevant Marketplace content based on current context — a Requirement viewed surfaces matching Seller Pages; a Use Case surfaces category templates; a Workspace surfaces category vendors.
...
Downgrade from paid → Free or paid → lower paid tier (Master Spec §34, §9 Buyer Pricing required feature #8, §17.4 Seller Pricing).
