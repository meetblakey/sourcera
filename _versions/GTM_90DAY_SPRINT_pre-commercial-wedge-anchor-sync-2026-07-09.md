...
|---|---|---|---|
| 1.1.1 | Buyer Free workspace creation, Cmd+K, Linear-benchmark shell | Workspace creatable in < 60 s from magic-link; Cmd+K navigates; 8 UX principles pass (Master Spec §3) | §6.1, §5 |
...
| 1.1.8 | Buyer AI Budget Meter — real-time consumption, $5/$50/$300/$800 | Meter renders on all Console screens; 80% warning email via Loops at threshold | Master Spec §34, §2.4 Buyer Pricing |
...
| # | Item | Acceptance | Source |
|---|---|---|---|
| 1.2.1 | Seller Hero Moment — 0-3 min onboarding from magic-link | p50 < 20 min magic-link → first submitted response across 5 dogfood bids | Master Spec §48, §14.2 Seller Pricing |
...
**Response:**
1. Re-read the Enterprise gate definitions (Master Spec §34, §6 Buyer Pricing): SSO, DPA, ≥$12K AI commit, custom integration. Are any being demanded inappropriately at Scale?
