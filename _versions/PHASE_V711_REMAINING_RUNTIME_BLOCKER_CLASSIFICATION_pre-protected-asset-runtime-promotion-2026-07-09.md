...
Current JSON proof: `_audit/_tmp/v711_stamp_gate_after_phase_8_webhook_p2.json`.

Exact-status right-edge scan after the Phase 8 webhook P2 closure: **0 open P0, 0 open P1, 0 blocked P1, 551 open P2, 190 open P3**.
...
```bash
tools/spec-lint/node_modules/.bin/tsx tools/release/stamp_gate.ts --json > _audit/_tmp/v711_stamp_gate_after_phase_8_webhook_p2.json
