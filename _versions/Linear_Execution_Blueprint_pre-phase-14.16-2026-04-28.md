# Sourcera — Linear Execution Blueprint (Hardened v2.0)

**Version:** 2.0.0
**Date:** 2026-04-12
**Status:** Production-Ready — Hardened Post-Audit
**Source Authority:** What_is_Sourcera.md, Sourcera_Master_Spec.md v6.0.0, UX_Design_of_Sourcera.md v2.0.0
...
- **Success Conditions:**
  ...
  - All core + advanced components documented and rendering
...
- **Initiative:** I1 | **Team:** Platform
- **Purpose:** Authentication, org/user/team/workspace lifecycle, RBAC, phase pipeline.
...
- **Dependencies:** P01
- **Milestones:** M02.1: Auth & Org Shell | M02.2: RBAC, Workspace Lifecycle & Phase Pipeline
- **Issues:** ~32
...
- **Purpose:** Use case and requirement management with Requirements Matrix.
...
- **Milestones:** M06.1: Use Case & Requirement CRUD + Matrix | M06.2: Triage, Amendments & Phase-Lock
- **Issues:** ~28
...
- **Initiative:** I2 | **Team:** Buyer Experience
- **Purpose:** Workspace analytics, Pulse, Selection Report, Intelligence Dashboard.
- **Scope:** Analytics page (scoring progress, response rate, phase duration, score distribution, weight coverage, SLA compliance, team velocity), Pulse Health Score (0.3×SLA+0.3×Scoring+0.2×Response+0.2×Velocity), Pulse widget+full view+digest archive, Selection Report (Phase 12 PDF with rankings/narratives/audit), export (CSV/PDF/Excel), Intelligence Dashboard (Business+: vendor history/efficiency; Enterprise: discrepancy/predictive).
- **Dependencies:** P08, P04 (EvaluationPulseEvent, IntelligenceCache), P06
- **Milestones:** M11.1: Analytics & Pulse | M11.2: Selection Report & Intelligence Dashboard
- **Issues:** ~16
...
- **Purpose:** Stripe billing and plan enforcement.
- **Scope:** Stripe integration (checkout, subscriptions, invoices, usage metering), plan enforcement middleware, entitlement registry, overage billing (Business), 14-day trial (no CC), upgrade/downgrade with proration, plan comparison page, agent token metering, invoice history.
- **Dependencies:** P02 (org with plan_tier)
- **Milestones:** M21.1: Stripe & Plan Enforcement | M21.2: Trial, Upgrade & Metering
- **Issues:** ~14
...
### P04: Core Data Layer & API (48 issues)
...
### P24: QA, Performance & Launch Prep (28 issues)
...
**Total Issues: 462 across 24 projects, 6 initiatives.**
