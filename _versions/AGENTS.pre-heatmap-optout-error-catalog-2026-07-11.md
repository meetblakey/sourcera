...
**Current release correction (2026-07-11, Phase 37 timing/input/i18n closure).** The preceding current-source batch is a prior pass boundary. D-37-012, D-37-013, D-37-015, D-37-017, and D-37-018 are remediated. §37.1.1 is a new, bounded Authored Extension for session-warning, motion-control, and input-purpose behavior; `AE-V711-PH37-CONTROL-INPUT-01` is pending human sign-off and runtime evidence. §37.1.2 / §37.2.2 / §37.2.3 only compile current authority. Live status is 0 open P0, 0 open P1, 0 blocked P1, 265 open P2, and 90 open P3. The stamp gate is 497 runtime rows, 326 `runtime_active`, and 183 blockers: 118 M11.3, 29 M21.3, 13 M02.3, 9 M24.3, and 14 pending human-ratification release blockers. `_audit/V711_RUNTIME_STAMP_GATE_BLOCKER_INVENTORY.md` and `_audit/V711_BACKLOG_INDEX.md` are the current routing sources.
