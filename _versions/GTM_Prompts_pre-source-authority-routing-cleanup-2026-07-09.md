...
1. /sessions/upbeat-practical-maxwell/mnt/Sourcera/What_is_Sourcera.md — Read every section. You need the full product definition, personas, pipeline, scoring, competitive positioning, plan tiers, and design decisions.
2. /sessions/upbeat-practical-maxwell/mnt/Sourcera/Sourcera_Master_Spec.md — Read these sections:
   - Plan tiers and pricing (search for "Plan Tiers")
   - AI capability catalog (search for "Agent Capabilities" or "21 Cataloged")
   - Integration list
   - RBAC roles
   You need exact numbers for positioning claims.
</context_loading>
...
- Do not invent features not in What_is_Sourcera.md.
- Do not recommend brand positioning that requires brand awareness. Sourcera starts from zero.
- If compacted: re-read What_is_Sourcera.md and resume from the next incomplete section.
</anti_drift>
```
...
1. /sessions/upbeat-practical-maxwell/mnt/Sourcera/What_is_Sourcera.md — Full product, plan tiers, personas
...
- If compacted: re-read What_is_Sourcera.md and GTM_POSITIONING.md, then resume.
</anti_drift>
```
...
<context_loading>
Read these files completely:
1. /sessions/upbeat-practical-maxwell/mnt/Sourcera/What_is_Sourcera.md
...
- If compacted: re-read What_is_Sourcera.md, GTM_POSITIONING.md, and GTM_PLG_ARCHITECTURE.md, then resume.
</anti_drift>
```
...
<context_loading>
Read these files completely:
1. /sessions/upbeat-practical-maxwell/mnt/Sourcera/What_is_Sourcera.md — Focus on: The Marketplace section, Seller Console, Capability Declarations, Match Scoring, EOI workflow, the fact that vendor participation is free
2. /sessions/upbeat-practical-maxwell/mnt/Sourcera/GTM_POSITIONING.md
</context_loading>
...
- If compacted: re-read What_is_Sourcera.md marketplace sections and resume.
</anti_drift>
```
...
<context_loading>
Read these files completely:
1. /sessions/upbeat-practical-maxwell/mnt/Sourcera/What_is_Sourcera.md — The complete product definition
...
<anti_drift>
- All product claims must be from What_is_Sourcera.md.
