...
**Companion docs:** `Sourcera_Master_Spec.md` §19, §21.4, §22, §26, §27, §30, §31, §34, §40, §48, §49, §51; `Sourcera_Buyer_Pricing_Strategy.md` and `Sourcera_Seller_Pricing_Strategy.md` narrative companions; `GTM_POSITIONING.md` §1.2-1.3, §4, §5.2-5.4
