...
**Date:** 2026-04-20
**Source-of-Truth:** `Sourcera_Master_Spec.md` §19, §21.4, §22, §26, §27, §34, §48, §49, §51 · `Sourcera_Seller_Pricing_Strategy.md` v3 · `Sourcera_Buyer_Pricing_Strategy.md` v3 · `GTM_POSITIONING.md` §1–§3
...
**Anti-drift:** No new growth mechanics invented. Every pricing number cites Master Spec §34. Every capability referenced is cataloged in `Sourcera_Master_Spec.md §21.4` / §22. Where a surface is silent on an operational question, the gap is flagged as *Authored Extension* and tagged for human sign-off.
