...
3. `KB_Engineering_Spec.md` — authoritative for any Seller KB / MCP / Managed Agent / Retrieval / Indexing question. This is the **integration source** for Phase 3.
4. `Sourcera_Master_Summary.md` — authoritative for concepts not yet integrated; superseded by the Master Spec after v7.0.0 integration.
