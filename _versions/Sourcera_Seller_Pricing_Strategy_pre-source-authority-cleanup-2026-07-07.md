...
- `KB_Engineering_Spec.md` §13.2 — confirm `ai_operation_pricing` table includes all seller-side capabilities listed in §10 above — Phase 14.9.1 follow-up (KB_Engineering_Spec is retired post-v7.0.0; this check moves to §22's integrated KB engineering content).
