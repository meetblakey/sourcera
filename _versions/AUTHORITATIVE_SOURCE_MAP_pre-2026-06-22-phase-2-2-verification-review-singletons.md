...
| VERIFICATION-VERIFIED-SLA | Verified review SLA | §39 row `Verified review SLA` | 5 business days | §34.16.2 cited | OK. |
| VERIFICATION-CERTIFIED-SLA | Certified review SLA | §39 row `Certified review SLA` | 10 business days | §34.16.2 | OK. |
| VERIFICATION-RECERT | Certified re-review cadence | §39 row `Certified re-review cadence` | 90 days | §34.16.2 (rolling 12-month for Basic/Verified; annual for Certified) | **DRIFT — D-AS-008 (P3).** §34.16.2 says "Tiers expire on a rolling 12-month cadence for Basic and Verified; Certified requires an annual recertification audit." §39 row `Certified re-review cadence` declares 90 days. The 90-day field on `next_review_due_at` default is a near-expiry-warning lead-time, not the expiry cadence itself; the spec is ambiguous on which is which. Suggest annotating §39 row to clarify (warning lead-time vs. cadence). |
| VERIFICATION-APPEAL-WINDOW | Appeal after rejection | §39 row + §42.3.1 | 14 days (Authored Extension) | — | OK; AE flagged. |
| VERIFICATION-COOLDOWN | Post-rejection cooling-off | §39 row | 30 days | — | OK; AE flagged. |
...
| D-AS-008 | P3 | §39 row `Certified re-review cadence = 90 days` is ambiguous against §34.16.2 prose ("annual recertification audit") — likely 90-day field is a near-expiry warning lead-time, not the expiry cadence. |
