...
| Exact-status ledger scan | 0 open P0; 0 open P1; 0 blocked P1; 413 open P2; 139 open P3 |
| Stamp gate | **FAIL — 168 runtime-evidence blockers** |

The 413 P2 and 139 P3 rows remain real lower-severity documentation work. They are not represented as closed or historical. Per the required priority order, they are not a substitute for the unresolved release blockers above.
