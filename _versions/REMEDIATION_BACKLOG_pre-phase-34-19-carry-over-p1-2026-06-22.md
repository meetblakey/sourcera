...
| 21 | BL-P1-PH3419-DM | Phase 34.19 — Plan Upgrade/Downgrade | data_model | 2 | D-34.19-005, D-34.19-008 | §34.19 + §4.8 wallet/billing | Residual upgrade/downgrade carry-over work after the Phase 5.3 KB data-model pass: class/sub-class mapping drift and missing SavedSearch/SearchAlert entity backing. | Author §34.19.1.A protected-asset sub-class bridge and SavedSearch/SearchAlert backing entities or explicitly defer the asset class by version decision. D-34.19-001 through D-34.19-004 closed 2026-06-21 via AE-V72REM-PH5P53-DM-01. | Engineering + Pricing | M02.3 | M | PROD-165 | AE-V72REM-PH5P53-DM-01 closed overlapping field-table rows |
