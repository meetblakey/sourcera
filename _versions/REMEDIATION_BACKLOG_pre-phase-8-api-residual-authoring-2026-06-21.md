...
| 5 | BL-P1-PH8P81-API | Phase 8 — Prompt 8.1 — §32 API Coverage | api | 3 | D-V8.1-002, D-V8.1-006, D-V8.1-008 | §32 + Appendix I | Scope-corrected 2026-06-21 from the stale 13-count row. Remaining live API-authoring defects: OutcomeContract introspection, EOI lifecycle endpoints, and seller-side Bid Workspace / KB / Managed Agent / Bridge API families. D-V8.1-003 / -004 / -005 are closed by §32.5 Vendor Opt-Outs + Marketplace Discovery catalog registration; D-V8.1-015 is closed by syncing §32.5 / §32.6.1 to the already-authored §25.3.10a Disqualification Reversal contract; D-V8.1-014 / -020 / -023 / -024 / -025 were already closed by earlier 2026-06-21 passes; D-V8.1-001 / -009 / -021 / -026 sit in documentation / drift / webhook / data-model rows rather than this API-authoring count. | Author the three remaining §32 public API contracts with method / path / auth scope / rate-limit / cursor / schema / errors / idempotency / examples; keep broader §32.5 list-only parent and path-prefix hygiene tracked separately. | Engineering | M02.3 | L | PROD-261 | Composite AE row "§32 API completeness pack"; catalog subset verified at `_audit/PHASE_V72REM_PHASE_8_API_CATALOG_EXISTING_SURFACES_VERIFY.md`; reversal sync verified at `_audit/PHASE_V72REM_PHASE_8_DISQUALIFICATION_REVERSAL_API_SYNC_VERIFY.md` |
