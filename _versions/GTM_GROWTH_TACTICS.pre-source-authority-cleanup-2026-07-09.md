...
**Source authority:** `Sourcera_Master_Spec.md` §27, §34, §48, §49 (M1-M17, Loops 1-10, Hero Moment, Marketplace) · `GTM_POSITIONING.md` v1.0 §1 (ICP), §2-§3 (Personas), §6 (Category) · `GTM_PLG_ARCHITECTURE.md` v1.0 §1-§3 (Entry paths, activation), §5 (Mechanic execution plan).
