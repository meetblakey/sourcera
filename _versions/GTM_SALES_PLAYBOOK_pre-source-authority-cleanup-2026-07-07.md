...
**Source authority:** `Sourcera_Master_Summary.md` v1.1 · `Sourcera_Buyer_Pricing_Strategy.md` v2 · `Sourcera_Seller_Pricing_Strategy.md` v2 · `GTM_POSITIONING.md` v1.0 · `GTM_PLG_ARCHITECTURE.md` v1.0.
**Status:** Authoritative for the solo-operator sales motion until superseded.
...
7. Minutes from magic-link to first submitted requirement response (p50, p90) — §14.2 Seller Pricing
...
- **No Enterprise pitch without the gate.** Do not route to Enterprise until one of {SSO, DPA, ≥$12K AI commit, custom integration} is confirmed as a requirement (§2.6 Master Summary, §6 Buyer Pricing, §8 Seller Pricing).
...
**Outcome expectations:** ~40% conversion rate to paid on seller PQLs at Conversion Moment #1 with this outreach pattern (per §14.3 Seller Pricing analysis). Do not skip this play — it is the most valuable 4 hours of the founder's week.
...
**Proof point:** Tier breakdown (§4–8 Seller Pricing), Three conversion moments (§14.3 Seller Pricing).
...
For each, send the moment-specific email (§3.2 and §14.3 Seller Pricing).
