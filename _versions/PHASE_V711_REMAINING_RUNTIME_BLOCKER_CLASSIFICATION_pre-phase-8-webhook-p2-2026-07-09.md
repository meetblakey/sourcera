...
Current JSON proof: `_audit/_tmp/v711_stamp_gate_after_phase_3_1_rbac_governance_p2.json`.

Exact-status right-edge scan after the Phase 3.1 RBAC governance closure: **0 open P0, 0 open P1, 0 blocked P1, 560 open P2, 191 open P3**.
...
```bash
tools/spec-lint/node_modules/.bin/tsx tools/release/stamp_gate.ts --json > _audit/_tmp/v711_stamp_gate_after_phase_3_1_rbac_governance_p2.json
...
- Exact-status scan: 0 open P0, 0 open P1, 0 blocked P1, 560 open P2, 191 open P3.
