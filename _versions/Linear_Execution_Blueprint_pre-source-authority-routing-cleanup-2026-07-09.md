...
**Source Authority:** Sourcera_Master_Spec.md (v7.1.0-integration-in-progress, v6.0.0 baseline), UX_Design_of_Sourcera.md v2.0.0, Sourcera_Buyer_Pricing_Strategy.md v3, Sourcera_Seller_Pricing_Strategy.md v3, KB_Engineering_Spec.md (retired into Master Spec §22), `_integration/RECONCILIATION.md` Phase 14.0 → 14.10 (closed) entries, Build_Execution_Strategy.md v1.1.0
