...
| 39 | BL-P1-PHKB18-DRIFT | Phase KB18 — KB Eng ↔ §22 Cross-Check | enum / numerical_singleton | 3 | D-KB18-001 / -003 / -004 | §22 + §39 + Appendix J | Count-corrected 2026-06-22: the reconciliation table already identifies D-KB18-002 as not P1. The live P1 set is D-KB18-001 cite-verify reason enum drift, D-KB18-003 kb_retrieve query length singleton drift, and D-KB18-004 namespace_preference bounds drift. | Remediate by reconciling §22 schemas / invariants to Appendix J and §39 canonical rows. Retired KB spec remains historical only. | Engineering | M11.3 | M | DOC-049 | Verification at `_audit/PHASE_V72REM_TOP_TABLE_COUNT_HYGIENE_VERIFY.md` |
...
| 42 | BL-P1-PHPT-DOC | Phase PT — §34.1 Plan-Tier Walk | numerical_singleton | 2 | D-PT-001 / -002 | §34.1 / §34.2.5 + BPS/SPS v3 companions | Count-corrected 2026-06-22: D-PT-003 and D-PT-004 are P2 documentation-gap rows, not P1. The live P1 set is D-PT-001 Solo refund-open threshold drift and D-PT-002 KB Bootstrap entitlement drift. | Remediate numerical singletons by choosing canonical §34 values and aligning companion pricing documents or Master Spec references. | Pricing | — | M | DOC-038 | Verification at `_audit/PHASE_V72REM_TOP_TABLE_COUNT_HYGIENE_VERIFY.md` |
