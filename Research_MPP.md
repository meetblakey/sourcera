...
**Backup of v1.** Pre-rewrite snapshot at `legacy-import:_versions/Research_MPP.v1-pre-comprehensive-rewrite-2026-04-29.md` (143,713 bytes). All v1 strategic conclusions are preserved or strengthened in v2; the structural reframe does not change the recommendation.
