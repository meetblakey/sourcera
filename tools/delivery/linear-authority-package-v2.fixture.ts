...
export function buildLinearAuthorityBootstrapPackageV2Fixture(
  ...
  const capture: LinearNativeIdentityCapture = {
    ...
    issues,
    labels: [
      { id: REQUIREMENT_LABEL_ID, name: "Requirement", color: "#00aa00", description: null, archivedAt: null, inheritedFromId: null, isGroup: false, parentId: null, parentName: null, teamId: REQUIREMENTS_TEAM_ID, teamKey: "REQ" },
      { id: DECISION_LABEL_ID, name: "decision", color: "#0044aa", description: null, archivedAt: null, inheritedFromId: null, isGroup: false, parentId: TYPE_GROUP_ID, parentName: "Type", teamId: null, teamKey: null },
      { id: HUMAN_ONLY_LABEL_ID, name: "human-only", color: "#336699", description: null, archivedAt: null, inheritedFromId: null, isGroup: false, parentId: AGENT_GROUP_ID, parentName: "Agent", teamId: null, teamKey: null },
      { id: PLATFORM_LABEL_ID, name: "platform", color: "#336699", description: null, archivedAt: null, inheritedFromId: null, isGroup: false, parentId: DOMAIN_GROUP_ID, parentName: "Domain", teamId: null, teamKey: null },
      { id: MARKETPLACE_LABEL_ID, name: "marketplace", color: "#336699", description: null, archivedAt: null, inheritedFromId: null, isGroup: false, parentId: DOMAIN_GROUP_ID, parentName: "Domain", teamId: null, teamKey: null },
      { id: RISK_LABEL_IDS[0], name: "risk", color: "#E5484D", description: "Canonical delivery risk.", archivedAt: null, inheritedFromId: null, isGroup: false, parentId: TYPE_GROUP_ID, parentName: "Type", teamId: null, teamKey: null },
      { id: RISK_LABEL_IDS[1], name: "delivery-risk", color: "#D97706", description: "Delivery, governance, readiness, or operational execution risk.", archivedAt: null, inheritedFromId: null, isGroup: false, parentId: RISK_GROUP_ID, parentName: "Risk", teamId: null, teamKey: null },
      { id: RISK_LABEL_IDS[2], name: "financial-risk", color: "#A16207", description: "Billing, metering, pricing, or financial integrity risk.", archivedAt: null, inheritedFromId: null, isGroup: false, parentId: RISK_GROUP_ID, parentName: "Risk", teamId: null, teamKey: null },
      { id: RISK_LABEL_IDS[3], name: "security-risk", color: "#B91C1C", description: "Security-sensitive implementation or proof work.", archivedAt: null, inheritedFromId: null, isGroup: false, parentId: RISK_GROUP_ID, parentName: "Risk", teamId: null, teamKey: null },
      { id: RISK_LABEL_IDS[4], name: "compliance-risk", color: "#991B1B", description: "Compliance-sensitive implementation or proof work.", archivedAt: null, inheritedFromId: null, isGroup: false, parentId: RISK_GROUP_ID, parentName: "Risk", teamId: null, teamKey: null },
      { id: TYPE_GROUP_ID, name: "Type", color: "#888888", description: null, archivedAt: null, inheritedFromId: null, isGroup: true, parentId: null, parentName: null, teamId: null, teamKey: null },
      { id: AGENT_GROUP_ID, name: "Agent", color: "#777777", description: null, archivedAt: null, inheritedFromId: null, isGroup: true, parentId: null, parentName: null, teamId: null, teamKey: null },
      { id: DOMAIN_GROUP_ID, name: "Domain", color: "#777777", description: null, archivedAt: null, inheritedFromId: null, isGroup: true, parentId: null, parentName: null, teamId: null, teamKey: null },
      { id: RISK_GROUP_ID, name: "Risk", color: "#777777", description: null, archivedAt: null, inheritedFromId: null, isGroup: true, parentId: null, parentName: null, teamId: null, teamKey: null },
    ],
