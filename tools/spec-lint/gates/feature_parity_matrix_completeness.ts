...
const REQUIRED_FEATURES = [
  ...
  "Seller Maya Surface Abstraction",
  "Solo-Tier Surface Treatment",
  "ContestRecord — Customer Contest",
  "FreeAllowanceCounter",
  "DSAR / Right of Access",
  "Verification Review Application",
] as const;

const M5_TOKENS = [
  "critical current feature-surface coverage manifest",
  "§2 / §3 / §4 / §6 / §7 / §11–§37 / §44 / §48–§51",
