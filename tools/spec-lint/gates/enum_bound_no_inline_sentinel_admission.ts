...
const ENUM_EXPECTATIONS = new Map<string, string[]>([
  ...
  ["vendor_opt_out_scope_ref_type", ["marketplace_category", "seller_software", "category_page", "comparison_page", "guide_page", "market_intelligence_report", "public_selection_report", "seller_org_page", "software_page", "null"]],
  ["vendor_opt_out_page_type_filter", ["comparison_page", "category_page", "guide_page", "market_intelligence_report", "public_selection_report", "seller_org_page", "software_page"]],
