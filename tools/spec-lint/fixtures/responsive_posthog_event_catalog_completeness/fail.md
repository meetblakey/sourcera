...
Responsive events are informal.
...
|---|---|---|---|---|---|
| `responsive_posthog_event_catalog_completeness` | catalog_consistency | spec_binding_pending_pack_m02_3 | pr_lint | Event catalog. | M02.3 |
