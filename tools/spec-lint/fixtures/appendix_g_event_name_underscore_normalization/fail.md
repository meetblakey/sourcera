...
| :---- | :---- | :---- |
| `security.suspicious_login_attempt` | Mirror of Appendix C `security.suspicious_login_attempt` | `source_webhook_event_type='security.suspicious_login_attempt'`, `user_id` |
...
| :---- | :---- | :---- |
| `m14.bid_success_share.initiated` | Step 1 | M14–M17 Mechanics Events |
