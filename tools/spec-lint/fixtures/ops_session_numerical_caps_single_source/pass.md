...
The alert threshold, operational hard-close threshold, and separate link-table storage capacity resolve exclusively from §39. Crossing the alert threshold raises §42 P2. The request that reaches the operational hard-close threshold commits and closes the session. The higher storage capacity is reserved for audited migration and forensic import.
