...
| :---- | :---- | :---- | :---- | :---- |
| §4.2.6 | ApiToken | 1 (security-audit metadata) + 4 (secret material) | Pattern B on `created_by`, `updated_by`; token secret hard-deleted | Metadata retained; secret destroyed. |
