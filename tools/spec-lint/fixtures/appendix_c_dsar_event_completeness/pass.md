# Appendix C DSAR Event Completeness Pass Fixture
...
| `dsar_export_downloaded` | Audit mirror | `source_audit_event_type='dsar.export.downloaded'` |
...
| `dsar_cascade_resume` | Mirror | `source_webhook_event_type='dsar.cascade.resume'` |
