...
Mobile errors are handled by the app.
...
|---|---|---|---|---|---|
| `responsive_mobile_error_catalog_completeness` | catalog_consistency | spec_binding_pending_pack_m02_3 | pr_lint | Error catalog. | M02.3 |
