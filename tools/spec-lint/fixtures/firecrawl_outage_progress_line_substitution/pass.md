...
The sequencer reads `provider_health_state(firecrawl)` at line-render time. The scanning line MUST NOT render during outage; §48.8.7 #7 applies. The line is replaced with the substitute line `"Drafting from your KB while we connect to your website…"`. The pause is stored in `stage_3_firecrawl_outage_pause_ms` and checked against the Seller onboarding Stage-3 population-latency threshold.
