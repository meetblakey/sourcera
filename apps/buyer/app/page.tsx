  ...
  return (
    <main className="mx-auto flex min-h-screen max-w-5xl flex-col px-6 py-10 sm:px-10">
      <header className="flex items-center justify-between border-b border-border pb-5">
        <span className="font-semibold tracking-tight">Sourcera Buyer</span>
        <a
      ...
      <section className="my-auto max-w-3xl py-20">
        <p className="mb-4 font-mono text-sm text-primary">Buyer Console</p>
        <h1 className="text-balance text-4xl font-semibold tracking-tight sm:text-6xl">
          Run an accountable evaluation.
        </h1>
        <p className="mt-6 max-w-2xl text-pretty text-lg leading-8 text-muted-foreground">
          Requirements, seller responses, scoring, and selection will live in
