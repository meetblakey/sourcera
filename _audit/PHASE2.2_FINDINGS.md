...
Additional drift: every Summary §3.5 citation is **stale** (Master Summary retired in v7.0.0 per CLAUDE.md §2; snapshot at `_baselines/retired-sources/Sourcera_Master_Summary_v1.1_retired_2026-04-26.md`). All k-anon Summary §3.5 citations must redirect to §48.6.4. **D-2.2-026 P3 consistency_drift.**
