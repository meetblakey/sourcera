...
- §13.11.5 Free Allowance "10 ops lifetime per Org per §4.8.7 / Summary C.80 default" cites a retired source (`Sourcera_Master_Summary` was retired in v7.0.0; `_baselines/retired-sources/Sourcera_Master_Summary_v1.1_retired_2026-04-26.md`).
