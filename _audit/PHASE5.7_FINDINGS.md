...
- `_versions/Sourcera_Master_Summary_v1.1_retired_2026-04-26.md` for C.132 / C.133 / C.135 / C.136 / C.137 / C.140 / C.141 cross-references — verified `C.133 = Three Conversion Moments`, `C.135 = Seller Activation Metric`, `C.136 = Forced-Vendor-Signup Playbook`, `C.137 = Win/Loss Debrief`, `C.140 = Required Capabilities`, `C.141 = Anti-Patterns`. (The Phase-5.7 prompt body's parenthetical attributions — `C.137 / C.135 / C.140` for FVS / 3CM / Anti-Patterns — are the prompt's own miscitation, NOT a defect in the spec; the spec correctly cites C.136 / C.133 / C.141 throughout §49.)
