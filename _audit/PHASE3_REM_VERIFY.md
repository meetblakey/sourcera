...
| 9 | Pre-edit Master Spec backup at `legacy-import:_versions/Sourcera_Master_Spec.v7.1.0-pre-v7.2.0-REM-P0-6-2026-05-18.md` (md5 `377e11bfcf568731b1d1e8d9a5017b59`; 6,098,065 bytes) | ✓ Per reconciliation log + canonical-row trace |
...
| 7 | Pre-edit Master Spec backup at `legacy-import:_versions/Sourcera_Master_Spec.v7.1.0-pre-v7.2.0-REM-P3.2-D-11.3-002-2026-05-18.md` (md5 `917e55aa1c07f9f28e66f2adb24c63fa`; 6,112,078 bytes) | ✓ Per reconciliation log + canonical-row trace |
